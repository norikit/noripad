...
<p align="center">
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="https://raw.githubusercontent.com/norikit/norikit/main/assets/noripad/hero/dark_theme.svg"/>
    <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/norikit/norikit/main/assets/noripad/hero/light_theme.svg"/>
    <img src="https://raw.githubusercontent.com/norikit/norikit/main/assets/noripad/hero/light_theme.svg" alt="noripad" width="100%"/>
  </picture>
</p>

<p align="center">
  <strong>noripad</strong> is a norikit tool (purpose TBD) for the <strong>norikit</strong> ecosystem.<br/>
  Purpose not yet defined.
</p>

> [!NOTE]
> Work in progress. noripad is in early development and not yet usable.
